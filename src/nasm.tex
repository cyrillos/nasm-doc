...
\newcommand{\htextindex}[1]{#1\index{\MakeLowercase{#1}}\xspace}
\newcommand{\code}[1]{\colorbox{light-gray}{\texttt{#1}}\xspace}
\newcommand{\codeindex}[1]{\code{#1}\index{#1@\texttt{#1}}\xspace}
\newcommand{\indexcode}[1]{\index{#1@\texttt{#1}}\xspace}
\newcommand{\hcodeindex}[1]{\texttt{#1}\index{#1@\texttt{#1}}\xspace}
