...
\newcommand{\fullref}[1]{\textcolor{hcolor}{\hyperref[{#1}]{\ref*{#1}\xspace}}}

\newcommand{\xchapter}[2]{\chapter{#2}\label{ch:#1}\xspace}
\newcommand{\xsection}[2]{\section{#2}\label{sec:#1}\xspace}
\newcommand{\xsubsection}[2]{\subsection{#2}\label{subsec:#1}\xspace}
%
% Convertion table
%
% \C{name}              ->      \chapter{name}
