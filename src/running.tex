...
\subsection{The \codeindex{-o} Option: Specifying the \htextindex{Output File Name}}
\label{subsec:opt-o}
...
\subsection{The \codeindex{-f} Option: Specifying the \htextindex{Output File Format}}
\label{subsec:opt-f}
...
\subsection{The \codeindex{-l} Option: Generating a \htextindex{Listing File}}
\label{subsec:opt-l}
...
\subsection{The \codeindex{-M} Option: Generate \htextindex{Makefile Dependencies}}
...
\subsection{The \codeindex{-MG} Option: Generate \htextindex{Makefile Dependencies}}
...
\subsection{The \codeindex{-MF} Option: Set Makefile Dependency File}
...
\subsection{The \codeindex{-MD} Option: Assemble and Generate Dependencies}
...
\subsection{The \codeindex{-MT} Option: Dependency Target Name}
...
\subsection{The \codeindex{-MQ} Option: Dependency Target Name (Quoted)}
...
\subsection{The \codeindex{-MP} Option: Emit phony targets}
...
\subsection{The \codeindex{-F} Option: Selecting a \htextindex{Debug Information Format}}
...
\subsection{The \codeindex{-g} Option: Enabling \htextindex{Debug Information}}
\label{subsec:opt-g}
...
\subsection{The \codeindex{-X} Option: Selecting an \htextindex{Error Reporting Format}}
...
\subsection{The \codeindex{-Z} Option: Send Errors to a File}
...
\subsection{The \codeindex{-s} Option: Send Errors to \codeindex{stdout}}
\label{subsec:opt-s}
...
\subsection{The \codeindex{-i}\indexcode{-I} Option: Include File Search Directories}
\label{subsec:opt-i}
...
\subsection{The \codeindex{-p}\indexcode{-P} Option: \index{pre-including files}Pre-Include a File}
\label{subsec:opt-p}
...
\subsection{The \codeindex{-d}\indexcode{-D} Option: \index{pre-defining macros}Pre-Define a Macro}
\label{subsec:opt-d}
...
\subsection{The \codeindex{-u}\indexcode{-U} Option: \index{undefining macros}Undefine a Macro}
\label{subsec:opt-u}
...
\subsection{The \codeindex{-E}\indexcode{-e} Option: Preprocess Only}
...
\subsection{The \codeindex{-a} Option: Don't Preprocess At All}
\label{subsec:opt-a}
...
\subsection{The \codeindex{-O} Option: Specifying \htextindex{Multipass Optimization}}
...
\subsection{The \codeindex{-t} Option: Enable TASM Compatibility Mode}
\label{subsec:opt-t}
...
\subsection{The \codeindex{-w} and \codeindex{-W} Options: Enable or Disable Assembly \htextindex{Warnings}}
\label{subsec:opt-w}
...
\subsection{The \codeindex{-v} Option: Display \htextindex{Version} Info}
\label{subsec:opt-v}
...
\subsection{The \codeindex{-y} Option: Display Available Debug Info Formats}
\label{subsec:opt-y}
...
\subsection{The \codeindex{--prefix} and \codeindex{--postfix} Options}
...
\subsection{The \codeindex{NASMENV} \textindex{Environment} Variable}
...
\subsection{NASM Doesn't \codeindex{ASSUME}}
