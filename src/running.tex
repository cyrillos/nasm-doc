...
\section{NASM \textindexlc{Command-Line} Syntax}
...
\subsection{The \codeindex{-o} Option: Specifying the \textindexlc{Output File Name}}
\label{subsec:opt-o}
...
\subsection{The \codeindex{-f} Option: Specifying the \textindexlc{Output File Format}}
\label{subsec:opt-f}
...
\subsection{The \codeindex{-l} Option: Generating a \textindexlc{Listing File}}
\label{subsec:opt-l}
...
\subsection{The \codeindex{-M} Option: Generate \textindexlc{Makefile Dependencies}}
...
\subsection{The \codeindex{-MG} Option: Generate \textindexlc{Makefile Dependencies}}
...
\subsection{The \codeindex{-F} Option: Selecting a \textindexlc{Debug Information Format}}
...
\subsection{The \codeindex{-g} Option: Enabling \textindexlc{Debug Information}}
\label{subsec:opt-g}
...
\subsection{The \codeindex{-X} Option: Selecting an \textindexlc{Error Reporting Format}}
...
\subsection{The \codeindex{-O} Option: Specifying \textindexlc{Multipass Optimization}}
...
\subsection{The \codeindex{-w} and \codeindex{-W} Options: Enable or Disable Assembly \textindexlc{Warnings}}
\label{subsec:opt-w}
...
\subsection{The \codeindex{-v} Option: Display \textindexlc{Version} Info}
\label{subsec:opt-v}
...
\subsection{NASM Requires \textindexlc{Square Brackets} For \textindexlc{Memory References}}
...
\subsection{NASM Doesn't Store \textindexlc{Variable Types}}
...
\subsection{NASM Doesn't Support \textindexlc{Memory Models}}
...
\subsection{\textindexlc{Floating-Point} Differences}
\label{subsec:qsfpu}
