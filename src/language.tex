...
\subsection{\codeindex{INCBIN}: Including External \htextindex{Binary Files}}
\label{subsec:incbin}
...
\subsection{\codeindex{TIMES}: \htextindex{Repeating} Instructions or Data}
\label{subsec:times}
...
\subsection{\htextindex{Character Constants}}
...
\subsection{\htextindex{String Constants}}
...
\subsection{\index{UTF-16}\index{UTF-32}\htextindex{Unicode} Constants}
...
\htextindex{Floating-point} constants are acceptable only as arguments to
