...
have found a bug in NASM, please see \fullref{sec:bugs}.
...
optimization with the \code{-O} option (see \fullref{sec:opt-O}).
...
instructions should be generated. See \fullref{sec:opt-O}.
